...
class ResConfigSettings(models.TransientModel):
    ...
    twikey_base_url = fields.Char(string=" Twikey API url",related="company_id.twikey_base_url", readonly=False)
    twikey_api_key = fields.Char(string="Twikey API key",related="company_id.twikey_api_key", help="Add Api Key from Twikey", readonly=False, groups="base.group_system")
